...
public class User implements java.io.Serializable {
	...
	public User(String name, String lastname, String email, String google, String facebook, String username, String password,
	...
	public String toString() {
		return "entities.User[idUser=" + idUser + ", name=" + name + "]";
	}
